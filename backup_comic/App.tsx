...
export function App() {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {/* ── SITE MAIN CARD ── */}
      <main className="relative z-10 bg-[var(--bg-primary)] border-x-4 border-b-4 border-black shadow-[0_20px_0px_0px_#E23636] overflow-hidden mt-16 mb-[60vh]">
        <HeroSection />
        <AboutSection />
        <TerminalSection />
        <ProjectsSection />
      ...
      <div className="fixed bottom-0 left-0 right-0 z-1 pointer-events-auto w-full h-[60vh]">
        <FooterRevealSection />
      </div>
    </div>
  );
