...
const IconBrightnessDown = ({ className }: { className?: string }) => (
  <IconBase className={className}><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></IconBase>
);
const IconBrightnessUp = IconBrightnessDown;
...
const IconCaretUpFilled = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M5 16h14L12 5z"/></svg>
);
const IconCaretLeftFilled = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M16 5v14L5 12z"/></svg>
);
const IconCaretDownFilled = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M5 8h14l-7 11z"/></svg>
);
const IconChevronUp = ({ className }: { className?: string }) => (
  <IconBase className={className}><path d="m18 15-6-6-6 6"/></IconBase>
);
...
const IconMoon = ({ className }: { className?: string }) => (
  <IconBase className={className}><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></IconBase>
);
const IconPlayerSkipForward = ({ className }: { className?: string }) => (
  <IconBase className={className}><polygon points="5 4 15 12 5 20 5 4"/><line x1="19" x2="19" y1="5" y2="19"/></IconBase>
);
const IconPlayerTrackNext = IconPlayerSkipForward;
const IconPlayerTrackPrev = ({ className }: { className?: string }) => (
  <IconBase className={className}><polygon points="19 20 9 12 19 4 19 20"/><line x1="5" x2="5" y1="19" y2="5"/></IconBase>
);
const IconTable = ({ className }: { className?: string }) => (
  <IconBase className={className}><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18M3 15h18M9 3v18M15 3v18"/></IconBase>
);
const IconVolume = ({ className }: { className?: string }) => (
  <IconBase className={className}><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/></IconBase>
);
const IconVolume2 = ({ className }: { className?: string }) => (
  <IconBase className={className}><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/></IconBase>
);
const IconVolume3 = ({ className }: { className?: string }) => (
  <IconBase className={className}><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></IconBase>
);
const IconSearch = ({ className }: { className?: string }) => (
  <IconBase className={className}><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></IconBase>
);
...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[105vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:pt-0 md:pb-32"
    >
      {title ? (
        <motion.h2
          style={{
          ...
          className="mb-6 text-center text-3xl font-bold text-[var(--text-primary)]"
        >
          {title}
        </motion.h2>
      ) : null}
